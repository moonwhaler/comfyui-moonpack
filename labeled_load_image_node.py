...
class LabeledLoadImage:
    DESCRIPTION = (
        ...
        "top or bottom - the photo itself is never cropped or resized. A bold arrow in "
        ...
        "result. Use the node's Preview button for an instant, exact look at the result "
        "before queuing."
    )
